...
- DB 제약: `radius_km >= 0.01 and radius_km <= 50`
- 현재 UI 옵션: 10m, 50m, 100m, 300m, 500m, 1km, 3km, 10km
- README의 과거 반경 설명은 현재 앱 UI와 다를 수 있다.

결정: 개인기기 테스트 편의를 위해 10m/50m를 허용하고 50km UI 옵션은 제거한다. 기존 데이터 호환을 위해 DB 최대값 50km는 유지한다.
